...
mod_data.options_widgets = {
	{
		...
		["unit_text"] = " %",
		["tooltip"] =  "Set the chance for slave rats to have shields.",
		["range"] = {0, 100},
		["decimals_number"] = 0,
		["default_value"] = 25,
	},
	{
		...
		["unit_text"] = " %",
		["tooltip"] =  "Set the chance for clan rats to have shields.",
		["range"] = {0, 100},
		["decimals_number"] = 0,
		["default_value"] = 25,
	},
	{
		...
		["unit_text"] = " %",
		["tooltip"] =  "Set the chance for stormvermin to have shields.",
		["range"] = {0, 100},
		["decimals_number"] = 0,
		["default_value"] = 25,
	},
	{
		...
		["tooltip"] =  "Removes the running attacks from rats that still have their shield.",
		["default_value"] = true,
	},
	{
		...
		["tooltip"] =  "Rats can block attacks with their shields.",
		["default_value"] = false,
		["sub_widgets"] = {
			{
				...
				["text"] = "Shields Type",
				["tooltip"] = "Choose how the shields are implemented.\n\n" ..
					"--- Health ---\n" ..
			...
			},
			{
				...
				["tooltip"] = "Triggers comments about hitting armour on shield hits.",
				["default_value"] = true,
				["sub_widgets"] = {
					{
						...
						["unit_text"] = " sec",
						["tooltip"] =  "Seconds between armour comments.",
						["range"] = {10, 120},
						["decimals_number"] = 0,
						["default_value"] = 30,
					},
					{
						...
						["unit_text"] = " units",
						["tooltip"] = "The maximum distance another hero can be away to comment.",
						["range"] = {3, 30},
						["decimals_number"] = 0,
						["default_value"] = 10,
					},
			...
			},
			{
				...
				["tooltip"] = "Triggers particle effects on shield hits.",
				["default_value"] = true,
			},
			{
				...
				["tooltip"] = "Triggers sound effects on shield hits.",
				["default_value"] = true,
			},
			{
				...
				["tooltip"] = "Physically drop shields after the health is empty.",
				["default_value"] = true,
			},
		},
	},
	-- {
		...
		-- ["tooltip"] =  "Randomly give rats player weapons.",
		-- -- ["options"] = {
		...
		-- ["sub_widgets"] = {
			-- {
				...
				-- ["widget_type"] = "stepper",
				-- ["text"] = "Weapon Count",
				-- ["tooltip"] = "How many player weapons should be loaded and used?\n\n" ..
					-- "--- Default ---\n" ..
